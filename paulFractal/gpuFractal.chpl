...
var density : [densityDomain] uint(16) = 0;
...
on here.gpus[0]
{
    ...
    var gpuRandArr = randArr;
    var gpuDensity = density;

    foreach r in gpuRandArr
    with
    (
        in x, // I bet this doesn't work
        in y
    )
    {
        for i in 0..#64
